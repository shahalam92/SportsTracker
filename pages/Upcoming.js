...
import {View,Text,FlatList,TouchableHighlight,TouchableOpacity,BackHandler,Dimensions,Alert,RefreshControl,
...
export default class Upcoming extends Component{
    ...
    render(){
        ...
        fontSize:16,color:'#ffffff',fontFamily:'opensans-light'}}>Back</Text>
            ...
            <Text style={{
        fontWeight:'bold',
        fontSize:20,color:'#ffffff'}}>Upcoming events</Text>
                    </View>
               {/* </View> */}
                </View>
